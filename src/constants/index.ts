...
const feedbacks = [
  {
    ...
    review:
      'Отличное чувство баланса между скоростью и качеством. Он умеет быстро разбираться в незнакомом коде, аккуратно улучшая его, не ломая существующую логику. Такой разработчик повышает общий уровень команды.',
